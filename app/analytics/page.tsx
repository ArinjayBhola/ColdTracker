...
export default async function AnalyticsPage() {
  const a = await getEngagementAnalytics();
      ...
      <main className="flex-1 overflow-y-auto p-4 md:p-8">
        <div className="max-w-7xl mx-auto space-y-6 md:space-y-10 pt-16 md:pt-0">
          ...
          <div className="space-y-1">
            <h1 className="text-3xl md:text-4xl font-extrabold tracking-tight">Engagement Analytics</h1>
            <p className="text-muted-foreground text-sm flex items-center gap-2">
              <FiActivity className="w-4 h-4 text-primary" />
              How recipients interact with the emails you send
            </p>
          </div>
          ...
          {a.totalSent === 0 ? (
            <Card className="border-2 border-dashed">
              <CardContent className="flex flex-col items-center justify-center gap-3 py-16 text-center">
                ...
                <h2 className="text-xl font-bold">No tracked emails yet</h2>
