    ...
    <div className="grid min-h-screen bg-background md:grid-cols-[0.85fr_1.15fr]">
      <aside className="hidden border-r border-border bg-sidebar p-10 md:flex md:flex-col md:justify-between">
        ...
        <div className="max-w-sm">
          <p className="eyebrow mb-4">New workspace</p>
          <h2 className="font-display text-4xl font-semibold leading-[1.15] tracking-tight">Set up a clean pipeline for every outreach motion.</h2>
          <p className="mt-5 text-[0.9375rem] leading-7 text-muted-foreground">Track prospects, schedule follow-ups, and measure conversion from the first message.</p>
        </div>
